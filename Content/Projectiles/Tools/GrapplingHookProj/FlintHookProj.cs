...
namespace Xenon.Content.Projectiles.Tools.GrapplingHookProj
{
    ...
    public class FlintHookProj : ModProjectile
    {
        private static Asset<Texture2D> chainTexture;
        public override void SetStaticDefaults()
        {
            chainTexture = ModContent.Request<Texture2D>("Xenon/Content/Projectiles/Tools/GrapplingHookProj/FlintHookProj_Chain");
        }
