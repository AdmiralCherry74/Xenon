...
namespace Xenon.Content.Projectiles.Tools.GrapplingHookProj
{
    //Thank you Avalon for the code
    public class GarnetHookProj : ModProjectile
    {
        private static Asset<Texture2D> chainTexture;
        public override void SetStaticDefaults()
        {
            chainTexture = ModContent.Request<Texture2D>("Xenon/Content/Projectiles/Tools/GrapplingHookProj/GarnetHookProj_Chain");
        }
