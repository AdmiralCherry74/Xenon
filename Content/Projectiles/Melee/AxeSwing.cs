...
// I have NO idea what the actual fuck i'm doing - Emerald

namespace Xenon.Content.Projectiles.Melee
{
	...
	public class AxeSwing : ModProjectile
	{
		...
		public override string Texture => "Xenon/Content/Items/Weapons/Melee/Battleaxes/MoissaniteTriAxe"; // Use texture of item as projectile texture
