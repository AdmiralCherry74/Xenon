...
namespace Xenon.Content.Projectiles.Melee.Flail;

public class WarflailBall : ModProjectile
{
    private const string ChainTexturePath = "Xenon/Content/Projectiles/Melee/Flail/WarflailBallChain"; // The folder path to the flail chain sprite
    ...
    public override void SetDefaults()
    {
        ...
        Projectile.height = 32; // The height of your projectile
    ...
    public override void AI()
    {
        ...
        float launchSpeed = 11f; // How fast the projectile can move
