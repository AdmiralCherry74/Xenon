...
namespace Xenon.Content.Biomes.Somnolent
{
    public class SomnolentBackgroundStyle : ModSurfaceBackgroundStyle
    {
        ...
        {
            return BackgroundTextureLoader.GetBackgroundSlot(Mod, "Assets/Textures/Backgrounds/SomnolentBackgrounds/Surface/SomnolentClassicStyle/SomnolentSurfaceFar0");
        }
        public override int ChooseMiddleTexture()
        {
            return BackgroundTextureLoader.GetBackgroundSlot(Mod, "Assets/Textures/Backgrounds/SomnolentBackgrounds/Surface/SomnolentClassicStyle/SomnolentSurfaceMid0");
        }
        public override int ChooseCloseTexture(ref float scale, ref double parallax, ref float a, ref float b)
        {
            return BackgroundTextureLoader.GetBackgroundSlot(Mod, "Assets/Textures/Backgrounds/SomnolentBackgrounds/Surface/SomnolentClassicStyle/SomnolentCloseFAR0");
        }
        public override bool PreDrawCloseBackground(SpriteBatch spriteBatch)
        {
            ...
            string TexturePath = "Xenon/Assets/Textures/Backgrounds/SomnolentBackgrounds/Surface/SomnolentClassicStyle/SomnolentBackgroundCloseCLOSE0";
            string TexturePath2 = "Xenon/Assets/Textures/Backgrounds/SomnolentBackgrounds/Surface/SomnolentClassicStyle/SomnolentBackgroundCloseMID0";
            string TexturePath3 = "Xenon/Assets/Textures/Backgrounds/SomnolentBackgrounds/Surface/SomnolentClassicStyle/SomnolentBackgroundCloseFAR0";
    ...
    public class UndergroundSomnolentBackgroundStyle : ModUndergroundBackgroundStyle
    {
        public override void FillTextureArray(int[] textureSlots)
        {
            textureSlots[0] = ModContent.GetModBackgroundSlot($"{Mod.Name}/Assets/Textures/Backgrounds/SomnolentBackgrounds/UndergroundSomnolentBackground0_0"); // Sky border
            textureSlots[1] = ModContent.GetModBackgroundSlot($"{Mod.Name}/Assets/Textures/Backgrounds/SomnolentBackgrounds/UndergroundSomnolentBackground0_1"); // Undeground layer. refered to as Dirt Layer in code
            textureSlots[2] = ModContent.GetModBackgroundSlot($"{Mod.Name}/Assets/Textures/Backgrounds/SomnolentBackgrounds/UndergroundSomnolentBackground0_2"); // Underground-Cavern border. refered to as underground border in code
            textureSlots[3] = ModContent.GetModBackgroundSlot($"{Mod.Name}/Assets/Textures/Backgrounds/SomnolentBackgrounds/UndergroundSomnolentBackground0_3"); // Cavern. refered to as Underground in code.
            textureSlots[4] = ModContent.GetModBackgroundSlot($"{Mod.Name}/Assets/Textures/Backgrounds/SomnolentBackgrounds/UndergroundSomnolentBackground0_4"); // Hell border?
        }
    }
    public class UndergroundSomnolentIceBackgroundStyle : ModUndergroundBackgroundStyle
    {
        public override void FillTextureArray(int[] textureSlots)
        {
            textureSlots[0] = ModContent.GetModBackgroundSlot($"{Mod.Name}/Assets/Textures/Backgrounds/SomnolentBackgrounds/UndergroundSomnolentBackground0_0"); // Sky border
            textureSlots[1] = ModContent.GetModBackgroundSlot($"{Mod.Name}/Assets/Textures/Backgrounds/SomnolentBackgrounds/UndergroundSomnolentBackground0_1"); // Undeground layer. refered to as Dirt Layer in code
            textureSlots[2] = ModContent.GetModBackgroundSlot($"{Mod.Name}/Assets/Textures/Backgrounds/SomnolentBackgrounds/UndergroundSomnolentBackground0_2"); // Underground-Cavern border. refered to as underground border in code
            textureSlots[3] = ModContent.GetModBackgroundSlot($"{Mod.Name}/Assets/Textures/Backgrounds/SomnolentBackgrounds/UndergroundSomnolentIceBackground"); // Cavern. refered to as Underground in code.
            textureSlots[4] = ModContent.GetModBackgroundSlot($"{Mod.Name}/Assets/Textures/Backgrounds/SomnolentBackgrounds/UndergroundSomnolentBackground0_4"); // Hell border?
        }
    }
}