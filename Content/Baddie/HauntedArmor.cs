    ...
    public class HauntedArmor : ModNPC
    {
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            ...
            bestiaryEntry.Info.AddRange([
                ...
                new FlavorTextBestiaryInfoElement("Left behind, presumably by its owner, this abandoned armor became haunted to seek revenge on them... However since it can't see, it probably assumes any human is its owner. PS; Very First Enemy I ever created :3"),
            ]);
        }
