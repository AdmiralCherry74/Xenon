    ...
    public class SporeSlime : ModNPC
    {
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            ...
            bestiaryEntry.Info.AddRange([
                ...
                new FlavorTextBestiaryInfoElement("Despite spores being in it, it doesnt appear to be dying... infact, the slime and spore's seem to have a symbiotic relationship. How ever it seems like the Glowing Snail are it's Source of food"),
            ]);
        }
