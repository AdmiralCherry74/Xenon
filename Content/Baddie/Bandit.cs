    ...
    public class Bandit : ModNPC
    {
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            ...
            bestiaryEntry.Info.AddRange([
                ...
                new FlavorTextBestiaryInfoElement("Seemingly a bandit that arrived to ransack this abandoned land. even if they arnt durable, the dagger's they seem too possess often are still extremely deadly"),
            ]);
        }
