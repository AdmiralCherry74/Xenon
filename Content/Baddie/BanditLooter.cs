    ...
    public class BanditLooter : ModNPC
    {
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            ...
            bestiaryEntry.Info.AddRange([
                ...
                new FlavorTextBestiaryInfoElement("A Knife Throwing Bandit. He seemed to have looted more goodies than a typical Bandit. Probably still alive because of the knives however, so dont get hit!"),
            ]);
        }
