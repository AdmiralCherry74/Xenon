...
public class AugumnGenSystem : ModSystem
{
    // This is a WIP system
    // More or less trying to figure out how Worldgen works
    // - Emerald
    ...
    /*
        ...
        4. Dirt to Mud - Adds random mud patches
        5. Clean up Dirt - Self Explanitory
        6. Wet Jungle - Adds a water layer on the surface (DON'T DO THIS)
        7. Jungle Temple - Self Explanitory
        8. Hives - Self Explanitory
        9. Jungle Chests - Generates jungle shrines, not the ug trees.
        10. Wall Variety - Adds some wall variety.
        11. Burried Chests - UG Cabins.
        12. Jungle Chest Placement - I assume random chests in the Jungle.
        13. Temple - Furnishes the temple.
        14. Cave Walls - MORE CAVE WALL VARIETY!!!!
        15. Jungle Trees - Grows trees in the ug jungle
        16. Pots - Self Explanitory
        17. Spread Grass - Adds some more pizzazz to the jungle grass
        18. Quickmud - Xenon Quickmud generation (Will there be quickmulch???)
        19. Piles - Adds rock piles
        20. Plant Trees - Plants le trees
        21. Herbs - Generates Herbs
        22. Webs and Honey - Adds random honey spots
        23. Glowing Mushroom and Jungle Plants - Grows foliage
        24. Grow more Jungle Plants
        25. Vines - Self Explanitory
        26. Mud Walls in Jungle - Replaces the dirt walls for mud
        27. Larvae - Generates Larvae
        28. Lihzard Alter - In my testing the alter was already there, so probably a double check.
        29. Micro Biomes - Generates Rails and stuff, but also generates the UG Trees. Also might generate Hive
        30. Water plants - Generates Aquatic Plants, some probably exist for the Jungle.
    */
    /*
