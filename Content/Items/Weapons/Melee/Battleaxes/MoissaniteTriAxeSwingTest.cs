using Xenon.Content.Projectiles.Melee;
...
namespace Xenon.Content.Items.Weapons.Melee.Battleaxes
{
	...
	public class MoissaniteTriAxeSwingTest : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = ModContent.ProjectileType<SwingTest>(); // The sword as a projectile
		}
