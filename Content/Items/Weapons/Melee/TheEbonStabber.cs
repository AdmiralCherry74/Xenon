...
namespace Xenon.Content.Items.Weapons.Melee
{
    public class TheEbonStabber : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            Item.staff[Type] = true; // This allows the game to recognize our new item as a spear.
        }
        ...
        public override void SetDefaults()
        {
            ...
            Item.shootSpeed = 2000000000f; // The speed of the projectile measured in pixels per frame.
        ...
        public override void AddRecipes()
        {
            ...
            Ti.AddIngredient(ItemID.DemoniteBar, 10);
            Ti.AddIngredient(ItemID.ShadowScale, 5);
