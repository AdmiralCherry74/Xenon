...
public class ExampleThumper : ModItem
{
    public override void SetStaticDefaults()
    {
        ...
        //Every grenade thumper will use this Example grenade thumper as a way to have crossbow's use any type of bolt. Like Fire bolts
        //Item.shoot is commented out just in case
        //remove comments when making a proper grenade thumper!
    }
    ...
    public override void SetDefaults()
    {
        ...
        Item.damage = 50; // The damage for projectiles isn't actually 8, it actually is the damage combined with the projectile and the item together
