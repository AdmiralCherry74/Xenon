...
namespace Xenon.Content.Items.Placeable.Tile.BuildingTiles.Bricks;
...
public class SmoothRhyoliteBlock : ModItem
{
    ...
    public override void SetDefaults()
    {
        ...
        Item.createTile = ModContent.TileType<Xenon.Content.Tiles.BuildingTile.Bricks.SmoothRhyolite>();
        Item.width = 16;
        Item.useTurn = true;
        Item.useTime = 10;
