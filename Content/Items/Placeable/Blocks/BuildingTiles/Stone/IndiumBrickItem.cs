...
public class IndiumBrickItem : ModItem
{
    ...
    public override void SetDefaults()
    {
        ...
        Item.createTile = ModContent.TileType<IndiumBrick>();
        Item.width = 16;
        Item.useTurn = true;
        Item.useTime = 10;
    ...
    {
        Recipe.Create(ModContent.ItemType<IndiumBrickItem>(), 5)
            .AddIngredient(ItemID.StoneBlock, 5)
            .AddIngredient(ModContent.ItemType<IndiumOreBlock>())
            .AddTile(TileID.WorkBenches)
            .SortAfterFirstRecipesOf(ItemID.TungstenBrick)
            .Register();
    }
}
