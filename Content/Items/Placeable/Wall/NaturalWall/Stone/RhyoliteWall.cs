...
namespace Xenon.Content.Items.Placeable.Wall.NaturalWall.Stone;
...
public class RhyoliteWall : ModItem
{
    ...
    public override void SetDefaults()
    {
        ...
        Item.useTurn = true;
        Item.useTime = 10;
        Item.createWall = ModContent.WallType<Xenon.Content.Walls.NaturalWall.StoneWall.RhyoliteWall>();
