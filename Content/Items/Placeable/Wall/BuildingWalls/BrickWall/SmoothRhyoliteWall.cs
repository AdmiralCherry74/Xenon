...
using Xenon.Content.Items.Placeable.Tile.BuildingBlocks.Bricks;

namespace Xenon.Content.Items.Placeable.Wall.BuildingWalls.BrickWall;
...
public class SmoothRhyoliteWall : ModItem
{
    ...
    public override void SetDefaults()
    {
        ...
        Item.useTurn = true;
        Item.useTime = 10;
        Item.createWall = ModContent.WallType<Xenon.Content.Walls.BuildingWalls.BrickWall.SmoothRhyoliteWall>();
