...
namespace Xenon.Content.Items.Tools.MiscTools
{
	...
	public class SyrupBucket : ModItem
	{
		...
		public override void SetStaticDefaults()
		{
			...
			LiquidID_TLmod.Sets.CreateLiquidBucketItem[LiquidLoader.LiquidType<Syrup>()] = Type;
		...
		public override void HoldItem(Player player)
		{
			if (!player.JustDroppedAnItem)//make sure the player hasn't just dropped an item recently
			{
				...
				{
					if (tile.LiquidType != LiquidLoader.LiquidType<Syrup>())
					{
						return;
					}
				}
				...
				tile.LiquidType = LiquidLoader.LiquidType<Syrup>(); //...create a liquid tile...
