...
namespace Xenon.Content.Items.Tools.GrapplingHooks
{
    public class GarnetHook : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.shootSpeed = 11.25f; // This defines how quickly the hook is shot.
            Item.shoot = ModContent.ProjectileType<GarnetHookProj>(); // Makes the item shoot the hook's projectile when used.
        }
    }
}