...
public class JadeRobe : ModItem
{
    public override void SetDefaults()
    {
        ...
        Item.value = Item.sellPrice(0, 0, 75, 0); // (Platinum, Gold, Silver, Copper)
    ...
    {
        return body.type == ModContent.ItemType<JadeRobe>() && (head.type == ItemID.WizardHat || head.type == ItemID.MagicHat);
    }
