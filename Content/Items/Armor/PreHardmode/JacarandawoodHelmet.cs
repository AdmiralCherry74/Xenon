...
public class JacarandawoodHelmet : ModItem
{
    ...
    {
        return head.type == Type && body.type == ModContent.ItemType<JacarandawoodBreastplate>() && legs.type == ModContent.ItemType<JacarandawoodGreaves>();
    }
