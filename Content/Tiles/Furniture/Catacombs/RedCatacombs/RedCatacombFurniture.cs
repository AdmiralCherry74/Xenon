...
namespace Xenon.Content.Tiles.Furniture.Catacombs.RedCatacombs;

//public class RedCatacombBathtub : BathtubTemplate { }

//public class RedCatacombBed : BedTemplate
//{
//	public override int DropItem => ModContent.ItemType<RedCatacombBedItem>();
//}

public class RedCatacombBookcase : BookcaseTemplate { }

//public class RedCatacombCandelabra : CandelabraTemplate
//{
...
//public class RedCatacombCandle : CandleTemplate
//{
//	public override int DropItem => ModContent.ItemType<RedCatacombCandleItem>();
//	private static Asset<Texture2D> flameTexture;
//	public override void SetStaticDefaults()
//	{
//		base.SetStaticDefaults();
...
//public class RedCatacombChair : ChairTemplate
//{
//	public override int DropItem => ModContent.ItemType<RedCatacombChairItem>();
//}

//public class RedCatacombChandelier : ChandelierTemplate
//{
//	public override Color FlameColor => new Color(224, 26, 202, 0);
//	public override int DropItem => ModContent.ItemType<RedCatacombChandelierItem>();
...
//public class RedCatacombChest : ChestTemplate
//{
//	public override int DropItem => ModContent.ItemType<RedCatacombChestItem>();
...
//public class RedCatacombClock : ClockTemplate
//{
//	public override int DropItem => ModContent.ItemType<RedCatacombClockItem>();
//}

//public class RedCatacombDoorClosed : ClosedDoorTemplate
//{
//	public override int DropItem => ModContent.ItemType<RedCatacombDoorItem>();
//}

//public class RedCatacombDoorOpen : OpenDoorTemplate
//{
//	public override int DropItem => ModContent.ItemType<RedCatacombDoorItem>();
//}

//public class RedCatacombDresser : DresserTemplate
//{
//	public override int DropItem => ModContent.ItemType<RedCatacombDresserItem>();
//}

//public class RedCatacombLamp : LampTemplate
//{
//	public override int DropItem => ModContent.ItemType<RedCatacombLampItem>();
//	private static Asset<Texture2D> flameTexture;
//	public override void SetStaticDefaults()
//	{
//		base.SetStaticDefaults();
...
//public class RedCatacombLantern : LanternTemplate
//{
//	public override bool HasFlameTexture => false;
//	public override int DropItem => ModContent.ItemType<RedCatacombLanternItem>();
//	public List<Point> Coordinates = new List<Point>();
//	private static Asset<Texture2D> flameTexture;
//	public override void SetStaticDefaults()
//	{
...
//public class RedCatacombPiano : PianoTemplate { }

//public class RedCatacombPlatform : PlatformTemplate
//{
//	public override int Dust => ModContent.DustType<RedCatacombDust>();
//}

//public class RedCatacombSink : SinkTemplate { }

//public class RedCatacombSofa : SofaTemplate
//{
//	public override int DropItem => ModContent.ItemType<RedCatacombSofaItem>();
//}

//public class RedCatacombTable : TableTemplate { }

//public class RedCatacombToilet : ToiletTemplate
//{
//	public override int DropItem => ModContent.ItemType<RedCatacombToiletItem>();
//}

//public class RedCatacombWorkBench : WorkbenchTemplate { }
