...
{
    public class DiamondCandelabraTile : CandelabraTemplate
    {
        public override int DropItem => ModContent.ItemType<DiamondCandelabra>();
        public override int FlameDust => DustID.WhiteTorch;
