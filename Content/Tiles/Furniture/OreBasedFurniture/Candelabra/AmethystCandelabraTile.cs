...
{
    public class AmethystCandelabraTile : CandelabraTemplate
    {
        public override int DropItem => ModContent.ItemType<AmethystCandelabra>();
        public override int FlameDust => DustID.PurpleTorch;
