...
{
    public class SapphireCandelabraTile : CandelabraTemplate
    {
        public override int DropItem => ModContent.ItemType<SapphireCandelabra>();
        public override int FlameDust => DustID.BlueTorch;
