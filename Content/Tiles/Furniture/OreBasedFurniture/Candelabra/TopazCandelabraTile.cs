...
{
    public class TopazCandelabraTile : CandelabraTemplate
    {
        public override int DropItem => ModContent.ItemType<TopazCandelabra>();
        public override int FlameDust => DustID.YellowTorch;
