...
{
    public class JadeCandelabraTile : CandelabraTemplate
    {
        public override int DropItem => ModContent.ItemType<JadeCandelabra>();
        public override int FlameDust => DustID.GreenMoss;
