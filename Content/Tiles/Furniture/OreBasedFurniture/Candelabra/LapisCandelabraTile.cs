...
{
    public class LapisCandelabraTile : CandelabraTemplate
    {
        public override int DropItem => ModContent.ItemType<LapisCandelabra>();
        public override int FlameDust => DustID.ShadowbeamStaff;
