...
{
    public class EmeraldCandelabraTile : CandelabraTemplate
    {
        public override int DropItem => ModContent.ItemType<EmeraldCandelabra>();
        public override int FlameDust => DustID.GreenTorch;
