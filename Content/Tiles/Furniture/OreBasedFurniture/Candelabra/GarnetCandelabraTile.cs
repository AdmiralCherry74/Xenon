...
{
    public class GarnetCandelabraTile : CandelabraTemplate
    {
        public override int DropItem => ModContent.ItemType<GarnetCandelabra>();
        public override int FlameDust => DustID.PinkTorch;
