...
{
	public class OliveTorch : ModTorch
	{
		public override Vector3 LightColor => new Vector3(0.4f, 0.5f, 0.3f);
		public override int TorchItem => ModContent.ItemType<Items.Placeable.Blocks.Decoration.Torches.OliveTorch>();
