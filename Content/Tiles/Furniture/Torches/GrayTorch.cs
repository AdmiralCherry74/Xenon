...
{
	public class GrayTorch : ModTorch
	{
		public override Vector3 LightColor => new Vector3(0.75f, 0.75f, 0.75f);
		public override int TorchItem => ModContent.ItemType<Items.Placeable.Blocks.Decoration.Torches.GrayTorch>();
