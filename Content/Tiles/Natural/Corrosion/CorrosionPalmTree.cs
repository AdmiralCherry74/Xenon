...
public class CorrosionPalmTree : ModPalmTree
{
	...
	public override void SetStaticDefaults()
	{
		...
		texture = ModContent.Request<Texture2D>("Xenon/Content/Tiles/Natural/Corrosion/CorrosionPalmTree");
		oasisTopsTexture = ModContent.Request<Texture2D>("Xenon/Content/Tiles/Natural/Corrosion/CorrosionOasisTree_Tops");
		topsTexture = ModContent.Request<Texture2D>("Xenon/Content/Tiles/Natural/Corrosion/CorrosionPalmTreeTops");
	}
