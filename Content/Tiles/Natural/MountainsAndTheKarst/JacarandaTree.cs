...
public class JacarandaTree : ModTree
{
    ...
    public override void SetStaticDefaults()
    {
		...
		texture = ModContent.Request<Texture2D>("Xenon/Content/Tiles/Natural/MountainsAndTheKarst/JacarandaTree");
		branchesTexture = ModContent.Request<Texture2D>("Xenon/Content/Tiles/Natural/MountainsAndTheKarst/JacarandaTreeBranches");
		topsTexture = ModContent.Request<Texture2D>("Xenon/Content/Tiles/Natural/MountainsAndTheKarst/JacarandaTreeTops");
	}
