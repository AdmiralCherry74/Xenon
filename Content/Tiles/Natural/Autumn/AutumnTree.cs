...
public class AutumnTree : ModTree
{
    ...
    public override void SetStaticDefaults()
    {
		...
		texture = ModContent.Request<Texture2D>("Xenon/Content/Tiles/Natural/Autumn/AutumnTree");
		branchesTexture = ModContent.Request<Texture2D>("Xenon/Content/Tiles/Natural/Autumn/AutumnTreeBranches");
		topsTexture = ModContent.Request<Texture2D>("Xenon/Content/Tiles/Natural/Autumn/AutumnTreeTops");
	}
    ...
    {
        style = 0;
        return ModContent.TileType<AutumnSapling>();
    }
