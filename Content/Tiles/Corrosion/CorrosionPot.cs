        ...
        if (!WorldGen.gen && Main.netMode != 1)
        {
            ...
            else
            {
                ...
                else if (num10 == 2)
                {
                    ...
                    {
                        Item.NewItem(WorldGen.GetItemSource_FromTileBreak(i, j), i * 16, j * 16, 16, 16, ModContent.ItemType<Items.Placeable.Tile.CorrosionTorch>(), torchStack); //Corrosion Torch
                    }
