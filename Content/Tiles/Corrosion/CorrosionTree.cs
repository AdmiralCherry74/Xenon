...
public class CorrosionTree : ModTree
{
    ...
    public override void SetStaticDefaults()
    {
		...
		texture = ModContent.Request<Texture2D>("Xenon/Content/Tiles/Corrosion/CorrosionTree");
		branchesTexture = ModContent.Request<Texture2D>("Xenon/Content/Tiles/Corrosion/CorrosionTreeBranches");
		topsTexture = ModContent.Request<Texture2D>("Xenon/Content/Tiles/Corrosion/CorrosionTreeTops");
	}
