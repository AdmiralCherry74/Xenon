...
public class CorrosionPalmSapling : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        TileObjectData.newTile.AnchorValidTiles = new int[1] { ModContent.TileType<Gutsand>() };
    ...
    public override void RandomUpdate(int i, int j)
    {
        if (WorldGen.genRand.NextBool(20))
        {
            ...
            if (WorldGen.GrowPalmTree(i, j) && flag)
            {
