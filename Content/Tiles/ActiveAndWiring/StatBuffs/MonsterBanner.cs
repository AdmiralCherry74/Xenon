...
using Xenon.Content.NPCs.Fighter;
using Xenon.Content.NPCs.Worm;
using Xenon.Content.NPCs.Caster;
using Xenon.Content.NPCs.Spider;
using Xenon.Content.NPCs.Flying;
using Xenon.Content.NPCs.UniqueAI;
using Xenon.Content.NPCs.Mimic;
using Xenon.Content.NPCs.Bat;
using Xenon.Content.NPCs.Unicorn;
using Xenon.Content.NPCs.Slime;
using Xenon.Content.NPCs.Fighter.Throwing;

namespace Xenon.Content.Tiles.ActiveAndWiring.StatBuffs;
