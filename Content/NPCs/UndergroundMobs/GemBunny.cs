...
{
    public abstract class GemBunny : ModNPC
    {
        ...
        {
            glowTexture = ModContent.Request<Texture2D>("Xenon/Content/NPCs/UndergroundMobs/GemBunny_Glow");
        }
    ...
    public class GarnetBunny : GemBunny
    {
        ...
        public override void SetDefaults()
        {
            ...
            NPC.friendly = false;
            NPC.catchItem = ModContent.ItemType<GarnetBunnyItem>();
        }
        public override void HitEffect(NPC.HitInfo hit)
        {
            ...
            {
                Gore.NewGore(NPC.GetSource_FromThis(), NPC.position, NPC.velocity.RotatedByRandom(MathHelper.Pi / 16), Mod.Find<ModGore>("GarnetBunnyGore0").Type);
                Gore.NewGore(NPC.GetSource_FromThis(), NPC.position, NPC.velocity.RotatedByRandom(MathHelper.Pi / 16), Mod.Find<ModGore>("GarnetBunnyGore1").Type);
            }
        }
    }
    public class JadeBunny : GemBunny
    {
        public override void SetStaticDefaults()
        {
            Main.npcFrameCount[Type] = 7;
        ...
        public override void SetDefaults()
        {
            ...
            AIType = NPCID.GemBunnyAmethyst;
            NPC.friendly = false;
            NPC.catchItem = ModContent.ItemType<JadeBunnyItem>();
        }
        public override void HitEffect(NPC.HitInfo hit)
        {
            Player player = Main.player[NPC.target];
            ...
            if (Main.netMode != NetmodeID.Server)
            {
                Gore.NewGore(NPC.GetSource_FromThis(), NPC.position, NPC.velocity.RotatedByRandom(MathHelper.Pi / 16), Mod.Find<ModGore>("JadeBunnyGore0").Type);
                Gore.NewGore(NPC.GetSource_FromThis(), NPC.position, NPC.velocity.RotatedByRandom(MathHelper.Pi / 16), Mod.Find<ModGore>("JadeBunnyGore1").Type);
            }
        }
    }
    public class LapisBunny : GemBunny
    {
        public override void SetStaticDefaults()
        {
            Main.npcFrameCount[Type] = 7;
        ...
        public override void SetDefaults()
        {
            ...
            AIType = NPCID.GemBunnyAmethyst;
            NPC.friendly = false;
            NPC.catchItem = ModContent.ItemType<LapisBunnyItem>();
        }
        public override void HitEffect(NPC.HitInfo hit)
        {
            Player player = Main.player[NPC.target];
            ...
            if (Main.netMode != NetmodeID.Server)
            {
                Gore.NewGore(NPC.GetSource_FromThis(), NPC.position, NPC.velocity.RotatedByRandom(MathHelper.Pi / 16), Mod.Find<ModGore>("LapisBunnyGore0").Type);
                Gore.NewGore(NPC.GetSource_FromThis(), NPC.position, NPC.velocity.RotatedByRandom(MathHelper.Pi / 16), Mod.Find<ModGore>("LapisBunnyGore1").Type);
            }
        }
    }
    public class FlintBunny : GemBunny
    {
        public override void SetStaticDefaults()
        {
            Main.npcFrameCount[Type] = 7;
        ...
        public override void SetDefaults()
        {
            ...
            AIType = NPCID.GemBunnyAmethyst;
            NPC.friendly = false;
            NPC.catchItem = ModContent.ItemType<FlintBunnyItem>();
        }
        public override void HitEffect(NPC.HitInfo hit)
        {
            Player player = Main.player[NPC.target];
            ...
            if (Main.netMode != NetmodeID.Server)
            {
                Gore.NewGore(NPC.GetSource_FromThis(), NPC.position, NPC.velocity.RotatedByRandom(MathHelper.Pi / 16), Mod.Find<ModGore>("FlintBunnyGore0").Type);
                Gore.NewGore(NPC.GetSource_FromThis(), NPC.position, NPC.velocity.RotatedByRandom(MathHelper.Pi / 16), Mod.Find<ModGore>("FlintBunnyGore1").Type);
            }
        }
    }
}