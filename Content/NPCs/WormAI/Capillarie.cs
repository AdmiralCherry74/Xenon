...
using static Xenon.Content.NPCs.WormAI.CapillarieHead.CapillarieBody;
...
public class CapillarieHead : WormHead
{
    ...
    {
        if ((spawnInfo.Player.ZoneCrimson && spawnInfo.Player.ZoneRockLayerHeight && NPC.downedBoss2 || spawnInfo.Player.ZoneCrimson && NPC.downedBoss2 && !spawnInfo.Player.InPillarZone()))
        {
    ...
    public class CapillarieBody : WormBody
    {
        ...
        public class CapillarieTail : WormTail
        {
            ...
            public override void Init()
            {
                CapillarieHead.CommonWormInit(this);
            }
        }
    }
}