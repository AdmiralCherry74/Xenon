...
{
	public class NeuroticManEater : ModNPC
	{
		...
		public override void SetStaticDefaults()
		{
			...
			VineTexture = Mod.Assets.Request<Texture2D>("Content/NPCs/CrimsonMobs/NeuroticManEater_Vine");
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
		{
			...
			bestiaryEntry.Info.AddRange([
                new FlavorTextBestiaryInfoElement(Language.GetTextValue("Mods.Xenon.Bestiary.NeuroticManEater")),
			]);
		}
