...
namespace Xenon.Content.Gores
{
    public class CorrosionLavaDroplet : ModGore
    {
        ...
        public override bool Update(Gore gore)
        {
            ...
            if (gore.frame <= 4)
            {
                ...
                if (gore.frameCounter >= frameDuration)
                {
                    ...
                    if (gore.frame == 5)
                    {
                        int droplet = Gore.NewGore(new EntitySource_Misc(nameof(CorrosionLavaDroplet)), gore.position, gore.velocity, gore.type);
