...
namespace Xenon.Common.Globals.XenonPlayerGlobals.PlayerDrawLayers
{
    public class LargeGemLayerXenon : PlayerDrawLayer
    {
        private static Asset<Texture2D> textureJade;
        private static Asset<Texture2D> textureGarnet;
        ...
        protected override void Draw(ref PlayerDrawSet drawInfo)
        {
            ...
            bool[] ownedLargeGems = drawPlayer.GetModPlayer<XenonPlayer>().OwnedLargeGems;
                ...
                if (numGems > 0f)
                {
                    ...
                    for (int num30 = 0; num30 < 10; num30++)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                case 7:
                                    texture2D4 = textureJade.Value;
                                    break;

                                case 8:
                                    texture2D4 = textureLapis.Value;
                                    break;

                                case 9:
                                    texture2D4 = textureGarnet.Value;
                                    break;
                            }
                        }
