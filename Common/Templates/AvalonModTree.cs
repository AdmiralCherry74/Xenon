...
/// <summary>
/// AvalonModTree. Made by Lion8cake.
/// </summary>
public abstract class AvalonModTree : ModTile
{
	public virtual string TexturePath => "Xenon/Content/Tiles/Natural/Ores/Gems/GemTrees/JadeTree";
	...
	public Texture2D GetTreeTopTexture(int tileType, int treeTextureStyle, byte tileColor)
	{
		...
		if (texture2D == null)
		{
			texture2D = (Texture2D)ModContent.Request<Texture2D>(TexturePath + "Tops");
		}
		return texture2D;
	}
	...
	public Texture2D GetTreeBranchTexture(int tileType, int treeTextureStyle, byte tileColor)
	{
		...
		if (texture2D == null)
		{
			texture2D = (Texture2D)ModContent.Request<Texture2D>(TexturePath + "Branches");
		}
		return texture2D;
	}
	...
	{
		if (tileType == ModContent.TileType<JadeTree>())
		{
			return JadeTree.GemTreeJade;
		}
		else if (tileType == ModContent.TileType<LapisTree>())
		{
			return LapisTree.GemTreeLapis;
		}
		else if (tileType == ModContent.TileType<GarnetTree>())
		{
			return GarnetTree.GemTreeGarnet;
		}
		else
		{
			return null;
	...
	public class TreeTopRenderTargetHolder : ARenderTargetHolder
	{
		...
		public override void Prepare()
		{
			...
			if (Key.TextureIndex == ModContent.TileType<JadeTree>())
			{
				asset = ModContent.Request<Texture2D>("Xenon/Content/Tiles/Natural/Ores/Gems/GemTrees/JadeTreeTops");
			}
			else if (Key.TextureIndex == ModContent.TileType<LapisTree>())
			{
				asset = ModContent.Request<Texture2D>("Xenon/Content/Tiles/Natural/Ores/Gems/GemTrees/LapisTreeTops");
			}
			else
			{
				asset = ModContent.Request<Texture2D>("Xenon/Content/Tiles/Natural/Ores/Gems/GemTrees/GarnetTreeTops");
			}
			if (asset == null)
			{
	...
	public class TreeBranchTargetHolder : ARenderTargetHolder
	{
		...
		public override void Prepare()
		{
			...
			if (Key.TextureIndex == ModContent.TileType<JadeTree>())
			{
				asset = ModContent.Request<Texture2D>("Xenon/Content/Tiles/Natural/Ores/Gems/GemTrees/JadeTreeBranches");
			}
			else if (Key.TextureIndex == ModContent.TileType<LapisTree>())
			{
				asset = ModContent.Request<Texture2D>("Xenon/Content/Tiles/Natural/Ores/Gems/GemTrees/LapisTreeBranches");
			}
			else
			{
				asset = ModContent.Request<Texture2D>("Xenon/Content/Tiles/Natural/Ores/Gems/GemTrees/GarnetTreeBranches");
			}
			if (asset == null)
			{
